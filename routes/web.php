...
Route::get('/ventas/create', [VentaController::class, 'create'])->name('createV');
...
Route::get('/ventas/{venta}/edit', [VentaController::class, 'edit'])->name('editV');
...
Route::get('/ventas/{venta}/calcularTotal', [VentaController::class, 'calcularTotalVenta'])->name('calcularTotalVenta');
Route::get('/ventas/reporte', [VentaController::class, 'generarReporteVentas'])->name('generarReporteVentas');
Route::get('/ventas/consultarPorProducto/{productoId}', [VentaController::class, 'consultarVentasPorProducto'])->name('consultarVentasPorProducto');
Route::post('/ventas/consultarPorFecha', [VentaController::class, 'consultarVentasPorFecha'])->name('consultarVentasPorFecha');
