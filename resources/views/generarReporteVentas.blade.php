<x-app-layout> <x-slot name="header"> <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
    {{ __('Reporte de Ventas') }} </h2>

    </x-slot> <div class="py-12"> <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    
            <div class="form-group">
            <div class="text-center">
                <h1>Generar Reporte de Ventas</h1> </div> <table class="table">
                    <thead>
                    <tr>
                    <th>ID de Venta</th>
            ...
            <div class="mb-3">
        <a href="{{ route('ventas') }}" class="btn btn-primary">Volver a la lista de ventas</a> </div> <form
            method="POST" action="{{ route('storeV') }}">
            @csrf
            </x-app-layout>